...
module.exports = class ServerQueue {
        ...
        async playAudio() {
            ...
            this.dispatcher = this.connection.play(Readable.from(ytdl(this.current.url, {fmt: "wav", encoderArgs: ["-af", "bass=g="+this.bass+",dynaudnorm=f=100", "-b:a", "1024k"], filter:"audioonly", quality: "highestaudio"})), {highWaterMark: 100});
